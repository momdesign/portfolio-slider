...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"js/throttle.js":[function(require,module,exports) {
"use strict";
...
var getNextPrev = function getNextPrev() {
  var activeSlide = document.querySelector('.slide.active');
  var activeIdx = slides.indexOf(activeSlide);
  var next, prev, nextAfterNext;
...
var setInitialSliderPosition = function setInitialSliderPosition() {
  var activeSlide = document.querySelector('.slide.active');
  var activeIdx = slides.indexOf(activeSlide);

  var _getNextPrev = getNextPrev(),
      _getNextPrev2 = _slicedToArray(_getNextPrev, 2),
      next = _getNextPrev2[0],
      prev = _getNextPrev2[1];

  slides.forEach(function (s, i) {
    if (i === activeIdx) {
      var _s$children$, _s$children$2;

      _gsap.default.set(s, {
        xPercent: 0
      });

      _gsap.default.set(s.children[0], {
        xPercent: (window.innerWidth - ((_s$children$ = s.children[0]) === null || _s$children$ === void 0 ? void 0 : _s$children$.clientWidth)) / (2 * ((_s$children$2 = s.children[0]) === null || _s$children$2 === void 0 ? void 0 : _s$children$2.clientWidth)) * 100
      });
    } else {
      if (s === prev) {
        _gsap.default.set(s, {
...
function goToNextSlide() {
  ...
  var _getNextPrev3 = getNextPrev(),
      _getNextPrev4 = _slicedToArray(_getNextPrev3, 3),
      next = _getNextPrev4[0],
      prev = _getNextPrev4[1],
      nextAfterNext = _getNextPrev4[2];
  ...
  slides.forEach(function (s, i) {
    if (i === activeIdx) {
      ...
      if (s === next) {
        var _s$children$3, _s$children$4;
        ...
        _gsap.default.to(s.children[0], {
          xPercent: (window.innerWidth - ((_s$children$3 = s.children[0]) === null || _s$children$3 === void 0 ? void 0 : _s$children$3.clientWidth)) / (2 * ((_s$children$4 = s.children[0]) === null || _s$children$4 === void 0 ? void 0 : _s$children$4.clientWidth)) * 100
        });
      } else {
        if (s === nextAfterNext) {
          _gsap.default.to(s, {
...
slides.forEach(function (s, i) {
  s.addEventListener('click', function () {
    return onSlideClick(i);
  });
});

var onSlideClick = function onSlideClick(i) {
  var activeSlide = document.querySelector('.slide.active');
  var activeIdx = slides.indexOf(activeSlide);

  var _getNextPrev5 = getNextPrev(),
      _getNextPrev6 = _slicedToArray(_getNextPrev5, 3),
      next = _getNextPrev6[0],
      prev = _getNextPrev6[1],
      nextAfterNext = _getNextPrev6[2];
...
function goToPrevSlide() {
  ...
  var _getNextPrev7 = getNextPrev(),
      _getNextPrev8 = _slicedToArray(_getNextPrev7, 2),
      next = _getNextPrev8[0],
      prev = _getNextPrev8[1];
  ...
  slides.forEach(function (s, i) {
    if (i === activeIdx) {
      ...
      if (s === prev) {
        var _s$children$5, _s$children$6;

        _gsap.default.fromTo(s, {
          xPercent: -100
        }, {
          xPercent: 0,
          duration: 0.7,
        ...
        _gsap.default.to(s.children[0], {
          xPercent: (window.innerWidth - ((_s$children$5 = s.children[0]) === null || _s$children$5 === void 0 ? void 0 : _s$children$5.clientWidth)) / (2 * ((_s$children$6 = s.children[0]) === null || _s$children$6 === void 0 ? void 0 : _s$children$6.clientWidth)) * 100
        });
      } else {
        if (s === next) {
          _gsap.default.to(s, {
...
;
var throttleClickNext = (0, _throttle.default)(function () {
  goToNextSlide();
}, 200);
var throttleClickPrev = (0, _throttle.default)(function () {
  goToPrevSlide();
}, 200);
...
},{"./throttle":"js/throttle.js","gsap":"node_modules/gsap/index.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
